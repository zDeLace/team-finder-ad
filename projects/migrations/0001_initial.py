    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=124, unique=True, verbose_name="Навык"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        default="",
                        validators=[users.validators.validate_github_url],
                        verbose_name="GitHub",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-created_at"], name="projects_pr_created_idx"
                    ),
